start_server {tags {"zset"}} {
    proc swap_zset {big} {
        ...
        if {$big} {
            r config set swap-big-zset-threshold 1
        } else {
            r config set swap-big-zset-threshold 1024000
        }
        ...
        proc stressers {encoding} {
            ...
            test "ZSET LOAD RDB EXIST EXPIRE DATA " {
                r del kv 
                for {set i 0} {$i < $elements} {incr i} {
                    set score [expr rand()]
                    lappend aux $score
            ...
            test "zrem non-existent subkey" {
                r zadd zrem_test 10 a 
                r evict zrem_test 
                r zrem zrem_test b 
            }
